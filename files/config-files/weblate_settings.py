...
ADMINS = (
    # ("Hartmut Holzgraefe", "webmaster@get-map.org"),
)
...
BASE_DIR =" @INSTALLDIR@/weblate"

# Data directory
DATA_DIR = "@INSTALLDIR@/weblate/data"
...
SECRET_KEY = "(6rm$_cz^p+4rt8p&tkp9o6hyjllo#4h*!c^4!r#@3&l&)sx4n"
...
SERVER_EMAIL = "webmaster@get-map.org"

# Default email address to use for various automated correspondence from
# the site managers. Used for registration emails.
DEFAULT_FROM_EMAIL = "webmaster@get-map.org"
